          ...
          children: <Widget>[
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FadeAnimation(1, Text('iCook Meals', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 30),)),
                  SizedBox(height: 20,),
                  Container(
                    height: 50,
                    child: ListView(
                      ...
                      children: <Widget>[
                        FadeAnimation(1, makeCategory(isActive: true, title: 'Meals')),
                        FadeAnimation(1.3, makeCategory(isActive: false, title: 'Efo')),
                        FadeAnimation(1.4, makeCategory(isActive: false, title: 'Vegetable')),
                        FadeAnimation(1.5, makeCategory(isActive: false, title: 'Plaintain')),
//                        FadeAnimation(1.6, makeCategory(isActive: false, title: 'Salad')),
            ...
            FadeAnimation(1, Padding(
              ...
              child: Text('Nigerian Recipes ', style: TextStyle(color: Colors.grey[700], fontSize: 20, fontWeight: FontWeight.bold),),
            )),
            Expanded(
              child: Padding(
                padding: EdgeInsets.symmetric(horizontal: 20.0),
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("\Meals", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
                      SizedBox(height: 30,),
//                      Text("Recipes", style: TextStyle(color: Colors.blueGrey, fontSize: 20),)
                    ],
                  )
                ],
              ),
